...
const options = {
    definition: {
        ...
        **ServiceText Pro Backend API**
        ...
        ## Support
        - **DPO Contact**: ${config_1.default.gdpr.dpo.email}
        - **Privacy Policy**: ${config_1.default.gdpr.urls.privacyPolicy}
      ...
      `,
        ...
        servers: [
            {
                url: `http://localhost:${config_1.default.app.port}/api/v1`,
...
function setupSwagger(app) {
    if (config_1.default.features.swagger) {
      ...
      `,
        ...
        console.log(`📚 Swagger documentation available at: http://localhost:${config_1.default.app.port}/api/v1/docs`);
    }
}
