...
const ViberBusinessService_1 = require("../services/ViberBusinessService");
const LocalModels_1 = require("../models/LocalModels");
const logger_1 = __importStar(require("../utils/logger"));
const router = (0, express_1.Router)();
const viberService = new ViberBusinessService_1.ViberBusinessService();
const database = new LocalModels_1.LocalDatabase();
