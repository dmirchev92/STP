...
exports.addReview = exports.sendMessage = exports.getInquiries = exports.createInquiry = exports.getNeighborhoods = exports.getCities = exports.getServiceCategories = exports.createOrUpdateProfile = exports.getProviderConversations = exports.searchProviders = exports.getProvider = void 0;
...
const searchProviders = async (req, res) => {
    try {
        ...
        logger_1.default.info('🔍 Searching providers with filters:', { city, category, limit, offset });
        let query = `
      SELECT 
...
const sendMessage = async (req, res) => {
    try {
        ...
        ) VALUES (?, ?, ?, ?, ?, ?, datetime('now'))`, [id, conversationId, senderType, senderName, message, messageType], function (err) {
                if (err) {
                    reject(err);
                }
                else {
