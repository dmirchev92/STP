...
exports.getUserPublicId = exports.getUnifiedMessages = exports.getUserConversations = exports.markAsRead = exports.getProviderConversations = exports.getConversation = exports.getMessages = exports.getAllMessages = exports.sendMessage = exports.startConversation = void 0;
...
const getUserPublicId = async (req, res, next) => {
    try {
        const { userId } = req.params;
        const DBClass = require('../models/SQLiteDatabase').SQLiteDatabase;
