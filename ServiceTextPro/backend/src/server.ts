...
class ServiceTextProServer {
  ...
  private initializeRoutes(): void {
    ...
    // Chat token system routes (existing implementation)
    // this.app.get('/api/v1/chat/tokens/:spIdentifier', chatTokenController.getTokens);
    // this.app.post('/api/v1/chat/public/:spIdentifier/validate/:token', chatTokenController.validateToken);
    // this.app.get('/api/v1/chat/sessions/:sessionId/validate', chatTokenController.validateSession);
  ...
  // Old public chat route removed - using new ChatTokenService system
  
  // Old latest token route removed - using new ChatTokenService system

  // Mobile app unified chat routes
